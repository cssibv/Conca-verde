...
(function(){
    ...
    overlay.innerHTML = '<div class="cv-popup"><button class="cv-popup-close" aria-label="Închide" id="cvPopupClose">&times;</button><div id="cvPopupContent"><div class="cv-popup-header"><div class="cv-badge">Ofertă Exclusivă</div><h3>5% Reducere la Prima Rezervare</h3><p>Abonează-te și primești codul de reducere direct pe email, plus oferte speciale și noutăți.</p></div><div class="cv-popup-body"><div class="cv-popup-perks"><span class="cv-popup-perk">🏷️ Cod -5%</span><span class="cv-popup-perk">📧 Oferte exclusive</span><span class="cv-popup-perk">🎁 Pachete sezoniere</span><span class="cv-popup-perk">🚫 Fără spam</span></div><form class="cv-popup-form" id="cvNewsletterForm"><input type="text" class="cv-popup-input" id="cvName" placeholder="Numele tău" autocomplete="given-name"><input type="email" class="cv-popup-input" id="cvEmail" placeholder="Adresa ta de email *" required autocomplete="email"><button type="submit" class="cv-popup-btn">Vreau Reducerea de 5% →</button></form><p class="cv-popup-note">🔒 Datele tale sunt în siguranță. <a href="/politica-confidentialitate">Politica de confidențialitate</a></p></div></div></div>';
    ...
    document.getElementById('cvNewsletterForm').addEventListener('submit', function(e) {
        ...
        waMessage += '🏷️ Solicită codul de reducere -5%\n\nMulțumesc!';
        var waUrl = 'https://wa.me/' + WA_NUMBER + '?text=' + encodeURIComponent(waMessage);

        var content = document.getElementById('cvPopupContent');
        content.innerHTML = '<div class="cv-popup-success"><div class="cv-check">🎉</div><h3>Mulțumim' + (name ? ', ' + name : '') + '!</h3><p>Codul tău de reducere <strong>VERDE5</strong> a fost trimis.<br>Folosește-l la următoarea rezervare pentru <strong>5% discount</strong>.</p><a href="' + waUrl + '" target="_blank" rel="noopener" class="cv-btn-wa"><svg width="18" height="18" viewBox="0 0 24 24" fill="white"><path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347z"/></svg>Rezervă cu -5% pe WhatsApp</a></div>';
